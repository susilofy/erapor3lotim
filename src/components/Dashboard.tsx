...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  const quickButtons = [
    ...
    { label: 'Kokurikuler (P5)', tab: 'kokurikuler' as ActiveTab, icon: Sparkles, color: 'bg-purple-50 text-purple-700 hover:bg-purple-100 border-purple-200' },
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-xs">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-8 gap-2 text-center text-xs">
          {[
            ...
            { step: '9', title: 'Kokurikuler P5', tab: 'kokurikuler' as ActiveTab },
